            ...
            <section className="rounded-lg border border-black/10 bg-white p-6">
              ...
              <div className="space-y-3">
                {loading ? (
                  <div className="space-y-3">
                    {[0, 1, 2].map((item) => (
                      <div key={item} className="flex items-center justify-between rounded-lg bg-black/[0.03] p-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="ml-auto h-5 w-16 animate-pulse rounded-full bg-black/10" />
                        </div>
                      </div>
                    ))}
                  </div>
